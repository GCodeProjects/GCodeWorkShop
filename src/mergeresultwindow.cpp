...
MergeResultWindow::MergeResultWindow(QWidget* pParent, OptionDialog* pOptionDialog) : QWidget( pParent )
{
...
void WindowTitleWidget::setEncodings( QTextCodec* pCodecForA, QTextCodec* pCodecForB, QTextCodec* pCodecForC )
{
   ...
   if ( pCodecForA )
      m_pEncodingSelector->addItem( tr("Codec from") + " A: " + pCodecForA->name(), QVariant::fromValue((void*)pCodecForA) );
   if ( pCodecForB )
      m_pEncodingSelector->addItem( tr("Codec from") + " B: " + pCodecForB->name(), QVariant::fromValue((void*)pCodecForB) );
   if ( pCodecForC )
      m_pEncodingSelector->addItem( tr("Codec from") + " C: " + pCodecForC->name(), QVariant::fromValue((void*)pCodecForC) );
