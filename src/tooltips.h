...
QString writeTooltipFile()
{
    ...
    settings.setValue("M16",
                      QT_TR_NOOP("<b>M16</b> - B or C-axis positioning, minus direction CCW"));
    ...
    settings.setValue("M52",
                      QT_TR_NOOP("<i>v.M</i> <b>M52</b> - mode of return to upper limit level" \
                                 "<br /><i>v.L</i> <b>M52</b> - "));
    settings.setValue("M53",
                      QT_TR_NOOP("<i>v.M</i> <b>M53</b> - mode of return to a specified point level set by G71" \
                                 "<br /><i>v.L</i> <b>M53</b> - "));
    settings.setValue("M54",
                      QT_TR_NOOP("<i>v.M</i> <b>M54</b> - mode of return to the point R level" \
                                 "<br /><i>v.L</i> <b>M54</b> - "));
    ...
    settings.setValue("M61",
                      QT_TR_NOOP("<b>M61</b> - Ignoring fixed rpm arrival in constant speed cutting"));
    ...
    settings.setValue("M85",
                      QT_TR_NOOP("<b>M85</b> - no return to the cutting starting point after the completion of rough turning cycle (LAP)"));
    ...
    settings.setValue("M130",
                      QT_TR_NOOP("<b>M130</b> - cutting feed; spindle rotating condition OFF"));
    settings.setValue("M131",
                      QT_TR_NOOP("<b>M131</b> - cutting feed; spindle rotating condition ON"));
    ...
    settings.setValue("M163",
                      QT_TR_NOOP("<b>M163</b> - M-tools spindle speed override fix (100%)"));
    ...
    settings.setValue("G02",
                      QT_TR_NOOP("<b>G02 X Y Z [I J K</b> | <b>L]</b> - circular interpolation CW"));
    settings.setValue("G03",
                      QT_TR_NOOP("<b>G03 X Y Z [I J K</b> | <b>L]</b> - circular interpolation CCW"));
    ...
    settings.setValue("G11",
                      QT_TR_NOOP("<b>G11</b> - parallel and rotation shift of coordinate system"));
    ...
    settings.setValue("G15",
                      QT_TR_NOOP("<b>G15 H</b>xx - selection of work coordinate system no. xx, modal"));
    settings.setValue("G16",
                      QT_TR_NOOP("<b>G15 H</b>xx - selection of work coordinate system no. xx, one-shot"));
    ...
    settings.setValue("G40",
                      QT_TR_NOOP("<b>G40</b> - tool nose/cutter radius compensation cancel"));
    ...
    settings.setValue("G54",
                      QT_TR_NOOP("<i>v.M</i> <b>G54 H</b>xx - tool length offset X-axis, xx - offset no." \
                                 "<br /><i>v.L</i> <b>G54</b> - "));
    settings.setValue("G55",
                      QT_TR_NOOP("<i>v.M</i> <b>G55 H</b>xx - tool length offset Y-axis, xx - offset no." \
                                 "<br /><i>v.L</i> <b>G55</b> - "));
    settings.setValue("G56",
                      QT_TR_NOOP("<i>v.M</i> <b>G56 H</b>xx - tool length offset Z-axis, xx - offset no." \
                                 "<br /><i>v.L</i> <b>G56</b> - "));
    settings.setValue("G57",
                      QT_TR_NOOP("<i>v.M</i> <b>G57 H</b>xx - tool length offset 4-axis, xx - offset no." \
                                 "<br /><i>v.L</i> <b>G57</b> - "));
    settings.setValue("G58",
                      QT_TR_NOOP("<i>v.M</i> <b>G58 H</b>xx - tool length offset 5-axis, xx - offset no." \
                                 "<br /><i>v.L</i> <b>G58</b> - "));
    settings.setValue("G59",
                      QT_TR_NOOP("<i>v.M</i> <b>G59 H</b>xx - tool length offset 6-axis, xx - offset no." \
                                 "<br /><i>v.L</i> <b>G59</b> - "));
    ...
    settings.setValue("G75",
                      QT_TR_NOOP("<i>v.L</i> <b>G75 G01 [X</b> | <b>Z] L</b>xxxx - chamfering 45deg. xxxx - direction and size"));
    settings.setValue("G76",
                      QT_TR_NOOP("<i>v.L</i> <b>G76 G01 [X</b> | <b>Z] L</b>xxxx - rounding. xxxx - direction and size"));
    ...
    settings.setValue("NCYL",
                      QT_TR_NOOP("<b>NCYL</b> - if specified in fixed cycle, positioning to the definied hole position is performed, but the cycle axis does not operate"));
    settings.setValue("NOEX",
                      QT_TR_NOOP("<b>NOEX</b> - if specified in fixed cycle, no axis movements may be performed"));
    ...
    settings.setValue("ROUND",
                      QT_TR_NOOP("<b>ROUND[</b>val<b>]</b> - integer implementation (rounding)"));
    settings.setValue("FIX",
                      QT_TR_NOOP("<b>FIX[</b>val<b>]</b> - integer implementation (truncation)"));
    settings.setValue("FUP",
                      QT_TR_NOOP("<b>FUP[</b>val<b>]</b> - integer implementation (raising)"));
    settings.setValue("DROUND",
                      QT_TR_NOOP("<b>DROUND[</b>val<b>]</b> - unit integer implementation (rounding)"));
    settings.setValue("DFIX",
                      QT_TR_NOOP("<b>DFIX[</b>val<b>]</b> - unit integer implementation (truncation)"));
    settings.setValue("DFUP",
                      QT_TR_NOOP("<b>DFUP[</b>val<b>]</b> - unit integer implementation (raising)"));
    ...
    settings.setValue("VUACM",
                      QT_TR_NOOP("<b>VUACM[</b>n<b>]='</b>text<b>'</b> - sub message for user definied alarms, n - subscript expression, text - max. 16 chracters"));

    settings.setValue("MODIN",
                      QT_TR_NOOP("<b>MODIN O</b>nnnn [<b>Q</b>]xx - subprogram call after axis movement, nnnn - prog. name, xx - number of repetitions"));
    ...
    settings.setValue("RSTRT",
                      QT_TR_NOOP("<b>RSTRT</b> - coordinate calculation function, restart"));
    ...
    settings.setValue("BHC",
                      QT_TR_NOOP("<b>BHC X Y I J K </b> - bolt hole circle, X Y - circle center, I - radius, J - angle of first hole, K - no. of holes"));
    ...
    settings.setValue("IF",
                      QT_TR_NOOP("<b>IF[</b>condition<b>] N</b>xxxx - if condition is true goto block xxxx"));
    ...
    settings.setValue("CALL",
                      QT_TR_NOOP("<b>CALL O</b>nnnn [<b>Q</b>xx] - call subprogram nnnn, repeat it xx times"));
    ...
    settings.setValue("VATOL",
                      QT_TR_NOOP("<b>VATOL</b> - active tool number, tool kind + tool number"));
    settings.setValue("VNTOL",
                      QT_TR_NOOP("<b>VNTOL</b> - next tool number, tool kind + tool number"));
    settings.setValue("VMLOK",
                      QT_TR_NOOP("<b>VMLOK</b> - equal zero if not in machine lock status"));
    ...
    settings.setValue("VMCOD",
                      QT_TR_NOOP("<b>VMCOD[</b>xx<b>]</b> - present M code of group no. xx"));
    settings.setValue("VSCOD",
                      QT_TR_NOOP("<b>VSCOD</b> - command value of present spindle speed S"));
    settings.setValue("VDCOD",
                      QT_TR_NOOP("<b>VDCOD</b> - present cutter radius compensation offset number"));
    settings.setValue("VFCOD", QT_TR_NOOP("<b>VFCOD</b> - command value of present feedrate F"));
    settings.setValue("VGCOD",
                      QT_TR_NOOP("<b>VGCOD[</b>xx<b>]</b> - present G code of group no. xx"));
    ...
    settings.setValue("VZOFX",
                      QT_TR_NOOP("<i>v.M</i> <b>VZOFX[</b>xx<b>]</b> - zero offset no. xx of X-axis" \
                                 "<br /><i>v.L</i> <b>VZOFX</b> - zero offset of X-axis"));
    settings.setValue("VZOFZ",
                      QT_TR_NOOP("<i>v.M</i> <b>VZOFZ[</b>xx<b>]</b> - zero offset no. xx of Z-axis" \
                                 "<br /><i>v.L</i> <b>VZOFZ</b> - zero offset of Z-axis"));
    settings.setValue("VZOFY",
                      QT_TR_NOOP("<i>v.M</i> <b>VZOFY[</b>xx<b>]</b> - zero offset no. xx of Y-axis"));
    ...
    settings.setValue("VTOFZ",
                      QT_TR_NOOP("<i>v.L</i> <b>VTOFZ[</b>xx<b>]</b> - tool offset no. xx of Z-axis"));
    settings.setValue("VTOFX",
                      QT_TR_NOOP("<i>v.L</i> <b>VTOFX[</b>xx<b>]</b> - tool offset no. xx of X-axis"));
    settings.setValue("VRSTT", QT_TR_NOOP("<b>VRSTT</b> - equal zero if not in restart state"));
    settings.setValue("VTOFH",
                      QT_TR_NOOP("<i>v.M</i> <b>VTOFH[</b>xx<b>]</b> - tool length, offset no. xx"));
    settings.setValue("VTOFD",
                      QT_TR_NOOP("<i>v.M</i> <b>VTOFD[</b>xx<b>]</b> - cutter radius, offset no. xx"));
    settings.setValue("VNCOM",
                      QT_TR_NOOP("<b>VNCOM[</b>xx<b>]</b> - communication for automation, no. xx"));
    //*******************************************************************************************************************//
    ...
    settings.setValue("G01", QT_TR_NOOP("<b>G01</b> - linear interpolation"));
    settings.setValue("G02",
                      QT_TR_NOOP("<b>G02 {X Y Z</b> | <b>U V W} {I J K</b> | <b>R} F</b> - circular interpolation CW; XYZ - end point (absolute); UW - end point (incremental); IJK - distance from start point to center; R - radius of arc"));
    settings.setValue("G03",
                      QT_TR_NOOP("<b>G03 {X Y Z</b> | <b>U V W} {I J K</b> | <b>R} F</b> - circular interpolation CCW; XYZ - end point (absolute); UW - end point (incremental); IJK - distance from start point to center; R - radius of arc"));
    settings.setValue("G04",
                      QT_TR_NOOP("<b>G04 X U P</b> - dwell XU - in seconds; P - in microseconds"));

    settings.setValue("G10",
                      QT_TR_NOOP("<b>G10 P X Z Y R Q</b> - change of offset value by program"));
    ...
    settings.setValue("G30",
                      QT_TR_NOOP("<b>G30 P</b>x - x = 2nd, 3rd, 4th reference point return"));
    ...
    settings.setValue("G70",
                      QT_TR_NOOP("<i>v.T</i> <b>G70 P Q</b> - finishing cycle; P - sequence number of the first block of finishing shape, Q - sequence number of last block"));
    settings.setValue("G71",
                      QT_TR_NOOP("<i>v.T</i> <b>G71 U R</b> - U - depth of cut, Q - escaping amount" \
    ...
    settings.setValue("G72",
                      QT_TR_NOOP("<i>v.T</i> <b>G72 W R</b> - U - depth of cut, Q - escaping amount" \
    ...
    settings.setValue("GE", QT_TR_NOOP("<b>GE</b> - greather than or equal to"));
    settings.setValue("IF",
                      QT_TR_NOOP("<b>IF[</b>condition<b>]</b>do something - if condition is true do something"));
    settings.setValue("GOTO", QT_TR_NOOP("<b>GOTO</b>nnnn - jump to block nnnn"));

    settings.setValue("WHILE",
                      QT_TR_NOOP("<b>WHILE[</b>condition<b>] DO</b>n <br />...<br />commands<br />... <br /><b>END</b>n  - loop - while condition true do commands beetwen DOn and ENDn"));
    ...
    settings.setValue("G57", QT_TR_NOOP("<b>G57</b> - settable zero offset 4"));
    settings.setValue("G58",
                      QT_TR_NOOP("<b>G58</b> - programmable offset, absolute axial substitution"));
    settings.setValue("G59",
                      QT_TR_NOOP("<b>G59</b> - programmable offset, additive axial substitution"));
    ...
    settings.setValue("@121",
                      QT_TR_NOOP("<b>@121 R</b>|<b>K</b>yy <b>R</b>|<b>K</b>xx <b>K</b>nnnn - if yy not equal to xx jump to nnnn"));
    settings.setValue("@122",
                      QT_TR_NOOP("<b>@122 R</b>|<b>K</b>yy <b>R</b>|<b>K</b>xx <b>K</b>nnnn - if yy equal to xx jump to nnnn"));
    settings.setValue("@123",
                      QT_TR_NOOP("<b>@123 R</b>|<b>K</b>yy <b>R</b>|<b>K</b>xx <b>K</b>nnnn - if yy is less than or equal to xx jump to nnnn"));
    settings.setValue("@124",
                      QT_TR_NOOP("<b>@124 R</b>|<b>K</b>yy <b>R</b>|<b>K</b>xx <b>K</b>nnnn - if yy is less than xx jump to nnnn"));
    settings.setValue("@125",
                      QT_TR_NOOP("<b>@125 R</b>|<b>K</b>yy <b>R</b>|<b>K</b>xx <b>K</b>nnnn - if yy is greather than or equal to xx jump to nnnn"));
    settings.setValue("@126",
                      QT_TR_NOOP("<b>@126 R</b>|<b>K</b>yy <b>R</b>|<b>K</b>xx <b>K</b>nnnn - if yy is greather than xx jump to nnnn"));
    ...
    settings.setValue("@630",
                      QT_TR_NOOP("<b>@630 R</b>xx <b>R</b>|<b>K</b>yy - sine of angle yy is stored in param. xx"));
    settings.setValue("@631",
                      QT_TR_NOOP("<b>@630 R</b>xx <b>R</b>|<b>K</b>yy - cosine of angle yy is stored in param. xx"));
    settings.setValue("@632",
                      QT_TR_NOOP("<b>@630 R</b>xx <b>R</b>|<b>K</b>yy - tangent of angle yy is stored in param. xx"));
    settings.setValue("@634",
                      QT_TR_NOOP("<b>@634 R</b>xx <b>R</b>|<b>K</b>yy - arc sine of angle yy is stored in param. xx"));
    ...
    settings.setValue("G53",
                      QT_TR_NOOP("<b>G53</b> - Suppression of current frames: Programmable frame including system frame for TOROT and TOFRAME and active settable frame G54 ... G599."));
    settings.setValue("G54", QT_TR_NOOP("<b>G54</b> - settable zero offset 1"));
    settings.setValue("G55", QT_TR_NOOP("<b>G55</b> - settable zero offset 2"));
    settings.setValue("G56", QT_TR_NOOP("<b>G56</b> - settable zero offset 3"));
    settings.setValue("G57", QT_TR_NOOP("<b>G57</b> - settable zero offset 4"));
    ...
    settings.setValue("G153",
                      QT_TR_NOOP("<b>G153</b> - suppression as for G53 and including all channel-specific and/or NCU-global basic frame"));
    settings.setValue("G500",
                      QT_TR_NOOP("<b>G500</b> - deactivate all settable G54-G57 frames if G500 does not contain a value"));

    settings.setValue("SUPA",
                      QT_TR_NOOP("<b>SUPA</b> - suppression as for G153 and including system frames for actual-value setting, scratching, zero offset external, PAROT including handwheel offsets (DRF), [zero offset external], overlaid motion"));

    settings.setValue("IF",
                      QT_TR_NOOP("<b>IF(</b>condition<b>)</b> nnnn - if condition is true goto block nnnn or label nnnn:"));
    settings.setValue("GOTO",
                      QT_TR_NOOP("<b>GOTO</b> nnnn - jump forward and if block not found jump backward to block nnnn or label nnnn:"));
    settings.setValue("GOTOF",
                      QT_TR_NOOP("<b>GOTOF</b> nnnn - jump forward to block nnnn or label nnnn:"));
    settings.setValue("GOTOB",
                      QT_TR_NOOP("<b>GOTOB</b> nnnn - jump backward to block nnnn or label nnnn:"));

    settings.setValue("STOPRE", QT_TR_NOOP("<b>STOPRE</b> - stop decoding, until buffer is empty"));

    settings.setValue("DIAMOF",
                      QT_TR_NOOP("<b>DIAMOF</b> - diameter programming OFF; radius programming for G90/G91"));
    settings.setValue("DIAMON",
                      QT_TR_NOOP("<b>DIAMON</b> - diameter programming ON; diameter programming for G90/G91"));
    settings.setValue("DIAM",
                      QT_TR_NOOP("<b>DIAM90</b> - diameter programming for G90; radius programming for G91"));
